            ...
            <div class="row">
                <div class="col-md-12">
                    <div class="block text-center">
                        ...
                        <h1 class="text-capitalize mb-5 text-lg">{{ $department->department_name }}</h1>
            ...
            <div class="row">
                <div class="col-lg-12">
                    <div class="department-img">
                        <img src="{{ asset('assets/FrontEnd/images/department/'.$department->image) }}" alt="" class="img-fluid">
                    </div>
                </div>
            </div>
            ...
            <div class="row">
                <div class="col-lg-8">
                    <div class="department-content mt-5">
                        <h3 class="text-md">{{ $department->department_name }}</h3>
                        <div class="divider my-4"></div>
                        <p class="lead">{{ $department->sub_title }}</p>
