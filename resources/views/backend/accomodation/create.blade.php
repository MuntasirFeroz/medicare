...
@section('accomodations', 'active') @section('accomodations-show', 'show') @section('accomodations-create', 'active')
@section('content')
    {!! Form::open(['class' => 'form-sample', 'route' => 'accomodation.store', 'method' => 'POST', 'enctype' => 'multipart/form-data']) !!}
    <div class="row">
        <div class="col-md-3"></div>
        <div class="col-md-6">
            <div class="page-header" id="bannerClose">
                <h3 class="page-title"><span class="page-title-icon bg-gradient-success text-white mr-2">
                        <i class="mdi  mdi-hotel"></i></span> Add New Accomodation
                </h3>
            </div>
            <div class="card">
                <div class="card-body">
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control" id="name" name="name"
                            placeholder="Enter Accomodation Name" required>
                    </div>
                    <div class="form-group">
                        <div class="form-row">
                            <div class="col-md-8">
                                <label for="image" id="imageLabel">Upload Photo</label>
                                <input type="file" class="form-control" id="imageUpload" onchange="loadImg()" name="image"
