                                        ...
                                        <tr>
                                            ...
                                            @if (Auth::user()->role == 'doctor')
                                                ...
                                                @if ($appointment->completed == 0)
                                                    <td class="text-center">   
                                                        <button type="button" class="btn-floating btn-inverse-primary btn-icon" onclick="window.location='{{route('backend.prescription.create',$appointment->id)}}'">Add Prescription</button>
                                                    </td>
                                                @else
                                                    <td class="text-center">
                                            ...
                                            @elseif (Auth::user()->role == 'patient')
                                                ...
                                                @endforelse
                                                    ...
                                                    @if ($appointment->completed == 1)
                                                        <td class="text-center">    
                                                            <button type="button" class="btn-floating btn-inverse-primary btn-icon" onclick="window.location='{{route('backend.prescription.show',$appointment->id)}}'">View Prescription</button>
                                                        </td>
                                                    @else
                                                        <td class="text-center"> Not Completed </td>
                                                    @endif
